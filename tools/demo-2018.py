...
def im_print():
	...
	if g_scoreTem > -1:
	    cv2.rectangle(im,(g_bboxTem[0], g_bboxTem[1]),(g_bboxTem[2], g_bboxTem[3]),(0,255,0),1)
	    cv2.putText(im, '{:s} {:.3f}%'.format(g_classTem, g_scoreTem*100),(int(g_bboxTem[0]), int(g_bboxTem[1]) - 2),cv2.FONT_HERSHEY_DUPLEX,1,(255,255,255),1)
...
if __name__ == '__main__':
    ...
    cv2.setWindowProperty("Endoscope",cv2.WND_PROP_FULLSCREEN,cv2.cv.CV_WINDOW_FULLSCREEN)
    #cv2.namedWindow("Old")
